...
export default function Directory() {
  ...
  const localProjects: Project[] = [
    {
      title: "My Local Portfolio Project",
      description: "This is a sample project loaded from local data. Built using React and TypeScript.",
      platform: "github", // Make sure this matches your platformDetails
      source: "https://github.com/shubhamjha2510/WhoDidWhat", // 👈 Put your repo link here
      demo: "https://google.com", // Optional: link to live demo
      language: "TypeScript",
      thumbnail: "", // Optional: link to image or leave blank
